...
void GameManager::GenerateMonster(int characterLevel)
{
	...
	//·£´ı ¼ıÀÚ »ı¼º(¸ó½ºÅÍ,¸ó½ºÅÍ °ø°İ·Â,¸ó½ºÅÍ Ã¼·Â)
	std::random_device rd;                // 1) ÇÏµå¿ş¾î ³­¼ö ½Ãµå
	...
	std::cout<<"Ã¼·Â:" << totalMonsterHealth	<< ", °ø°İ·Â : " << totalMonsterAttack <<"\n";
...
{
	std::cout << attacker->GetName() << "°¡ " << defender->GetName() << "À» °ø°İÇÕ´Ï´Ù! ";
